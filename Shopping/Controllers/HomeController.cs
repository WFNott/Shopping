...
namespace Shopping.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, DataContex dataContex, IUserHelper userHelper, IOrdersHelper ordersHelper)
        {
            _logger = logger;
            _context = dataContex;
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? pageNumber)
        {
            ...
            HomeViewModel model = new() { Products = await PaginatedList<Product>.CreateAsync(query, pageNumber ?? 1, pageSize)
