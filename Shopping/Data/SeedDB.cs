...
namespace Shopping.Data
{
    public class SeedDB
    {
        ...
        public SeedDB(DataContex context, IUserHelper userHelper, IBlobHelper blobHelper)
        {
            _context = context;
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Juan", "Zuluaga", "zulu@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "zulu.jpg", UserTypes.Admin);
            await CheckUserAsync("2020", "Alice", "Cullen", "Alice@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "Alice.jpg", UserTypes.User);
            await CheckUserAsync("3030", "Brad", "Pitt", "brad@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "Brad.jpg", UserTypes.User);
            await CheckUserAsync("4040", "Angelina", "Jolie", "angelina@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "Angelina.jpg", UserTypes.User);
            await CheckUserAsync("5050", "Bob", "Marley", "bobmarley@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "BobMarley.jpg", UserTypes.User);
        }
     ...
     UserTypes userType)
        {
            Guid imageId = await _blobHelper.UploadBlobAsync($"{Environment.CurrentDirectory}\\wwwroot\\Image\\Users\\{image}", "user");
